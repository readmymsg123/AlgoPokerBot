...
class FiveEval :
	...
	def __init__(self) :
		self.suit_lookup_table = {}
		self.number_lookup_table = {}
	...
	def initialize_lookup(self):
		...
		self.suit_lookup_table[0] = "s"
		self.suit_lookup_table[1] = "h"
		self.suit_lookup_table[8] = "d"
		self.suit_lookup_table[57] = "c"

		self.number_lookup_table[0] = "2"
		self.number_lookup_table[1] = "3"
		self.number_lookup_table[5] = "4"
		self.number_lookup_table[22] = "5"
		self.number_lookup_table[94] = "6"
		self.number_lookup_table[312] = "7"
		self.number_lookup_table[992] = "8"
		self.number_lookup_table[2422] = "9"
		self.number_lookup_table[5624] = "10"
		self.number_lookup_table[12522] = "J"
		self.number_lookup_table[19998] = "Q"
		self.number_lookup_table[43258] = "K"
		self.number_lookup_table[79415] = "A"
